        ...
        >
          ...
          <img src="{{asset('dashboard/images/patient-email.png')}}"  style="width: 100%;"/>
            ...
            <p
              ...
              "
            >
            <strong>How to Join Your Appointment:</strong> Please log into the Deluxe Hospital app and navigate to the "Chat" section at the scheduled time. {{$professional}} will be there.
