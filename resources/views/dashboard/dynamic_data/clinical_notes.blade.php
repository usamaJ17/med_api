...
@section('dynamic')
    active
@endsection
@section('dynamic.clinical_notes')
    active
@endsection
@section('content')
    ...
    <div class="content-header">
        <div class="d-flex align-items-center">
            <div class="me-auto">
                <h4 class="page-title">Clinical Notes</h4>
                    ...
                    <div class="box-body">
                        <div class="table-responsive rounded card-table">
                            <table class="table border-no" id="example1">
                                ...
                                <tbody>
                                    @foreach ($clinical_notes as $item)
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="{{ route('dynamic.clinical_notes.store') }}" method="POST">
                        @csrf
    ...
    <div class="modal fade" id="editModal" tabindex="-1" aria-labelledby="editModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form id="editForm" action="{{ route('dynamic.clinical_notes.update') }}"  method="POST">
                    @csrf
                    <div class="modal-body">
