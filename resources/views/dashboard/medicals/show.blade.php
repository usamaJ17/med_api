    ...
    <section class="content">
        ...
        <div class="row">
            <div class="col-xl-8 col-12">
                <div class="box">
                    <div class="box-body text-end min-h-150" style="background-image:url({{  asset('dashboard/images/auth-bg/bg-8.jpg') }}); background-repeat: no-repeat; background-position: center;background-size: cover;">
                        <div class="bg-success rounded10 p-15 fs-18 d-inline"><i class="fa fa-stethoscope"></i> {{ $medical->professionalDetails->professions->name }}</div>	
                    </div>						
                    <div class="box-body wed-up position-relative">
                        <div class="d-md-flex align-items-end">
                            <img src="{{  $medical->getFirstMediaUrl() }}" style="max-height: 150px; width: auto" class="bg-success-light rounded10 me-20" alt="" />
                            <div>
                                <h3>{{ $medical->first_name . " " . $medical->last_name }}</h3>
                                <h5>{{ $medical->professionalDetails->ranks->name   }}</h5>
                                <p><i class="fa fa-clock-o"></i> Join on {{ \Carbon\Carbon::parse($medical->created_at)->format('d/m/Y H:m')}}</p>
                            </div>
                        </div>
                    </div>						
                    <div class="box-body">
                ...
                <div class="box">
                    ...
                    <div class="box-footer">
                        <a href="#" class="waves-effect waves-light d-block w-p100 btn btn-primary">Load More Reviews</a>
                    </div>
                </div>
            </div>
